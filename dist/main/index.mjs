...
const sourceFile = (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)("source-file", { required: true });
const destinationFile = (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)("destination-file", { required: true });

await (0,_actions_io__WEBPACK_IMPORTED_MODULE_1__.cp)(sourceFile, destinationFile);
(0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.setOutput)("copied-file", destinationFile);
